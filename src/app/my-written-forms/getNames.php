...
$SQL = "SELECT DoctorEmail, id, email, name, gender, diagnosis, allergies, medication, date, procedures, notes FROM medicalform  WHERE DoctorEmail = '$email'";
...
while($patient = mysqli_fetch_assoc($stmt)){
    $patients[] = $patient;
}
